    ...
    public void callLlmAndSave(AiRequested request) {
        try {
            ...
            String prompt = String.format(
                "Create a highly detailed and visually rich book cover illustration based on the following title and content. " +
                "Ensure that the artwork clearly reflects the themes and mood of the story. " +
                "Do not include any text, lettering or titles on the image.\n\n" +
                "Title: \"%s\"\nContent: \"%s\"",
                request.getTitle(), request.getAiSummary()
            );
