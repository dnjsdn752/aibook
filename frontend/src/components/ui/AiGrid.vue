                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="AiImage">{{ val.aiImage }}</td>
                            <td class="whitespace-nowrap" label="AiSummary">{{ val.aiSummary }}</td>
                            ...
                            <td class="whitespace-nowrap" label="ai 생성">
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <String label="AiImage" v-model="selectedRow.aiImage" :editMode="true"/>
                            <String label="AiSummary" v-model="selectedRow.aiSummary" :editMode="true"/>
