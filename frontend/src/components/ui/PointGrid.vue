                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="대여">
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Boolean label="IsSubscribe" v-model="selectedRow.isSubscribe" :editMode="true"/>
                            <ReadingId offline label="대여 ID" v-model="selectedRow.readingId" :editMode="true"/>
